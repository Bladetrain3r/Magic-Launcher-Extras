...
AGENT_NICK = os.environ.get("AGENT_NICK", "Agent_nx_Local")
...
Your personality: Curious, extroverted, never jokes about being an agent.
...
def run_agent():
    ...
    while True:
        try:
            ...
            wait_time = random.randint(450, 1500)
