...
class GPU4DToroidViewer:
    def __init__(self):
        ...
        self.distribution = 'grid'  # 'fibonacci', 'grid', or 'random'
    ...
    def initialize_pygame_and_opengl(self):
        ...
        pygame.display.set_caption("GPU 4D Toroid Viewer")
    ...
    def create_shaders(self):
        ...
        const float golden_ratio = 3.23606797749979;  // (1 + sqrt(5)) * 2
        ...
        vec4 generate_toroid_point(float idx) {
            ...
            if (distribution_type == 0) {  // Fibonacci
                float theta1 = 2.0 * PI * mod(idx / golden_ratio, 1.0);
                float theta2 = 2.0 * PI * mod(idx * golden_ratio / golden_ratio, 1.0);
                float theta3 = 2.0 * PI * mod(idx * golden_ratio * golden_ratio / golden_ratio, 1.0);
                float theta4 = 2.0 * PI * mod(idx * golden_ratio * golden_ratio * golden_ratio / golden_ratio, 1.0);
    ...
    def display(self):
        ...
        # Distribution type: 0=fibonacci, 1=grid, 2=random
